...
if("TRUE" STREQUAL "TRUE")
  set(orbbec_camera_SOURCE_PREFIX /home/ubuntu/Deep_Camera/src/OrbbecSDK_ROS1-main)
  set(orbbec_camera_DEVEL_PREFIX /home/ubuntu/Deep_Camera/devel)
  ...
  set(orbbec_camera_INSTALL_PREFIX /home/ubuntu/Deep_Camera/install)
...
if(NOT "/home/ubuntu/Deep_Camera/devel/include;/home/ubuntu/Deep_Camera/src/OrbbecSDK_ROS1-main/include " STREQUAL " ")
  set(orbbec_camera_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/Deep_Camera/devel/include;/home/ubuntu/Deep_Camera/src/OrbbecSDK_ROS1-main/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'orbbec_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/Deep_Camera/src/OrbbecSDK_ROS1-main/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntu/Deep_Camera/devel/lib;/opt/ros/noetic/lib)
